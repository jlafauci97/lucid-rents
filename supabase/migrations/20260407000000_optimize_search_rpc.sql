-- Optimize search: add fast btree-based search for address queries,
-- keep GIN-based search_buildings_ranked for name/owner searches.

-- Fast address search using btree index on (metro, full_address).
-- Addresses start with a house number so prefix matching works perfectly.
CREATE OR REPLACE FUNCTION search_buildings_fast(
  search_query text,
...
RETURNS SETOF json AS $$
  WITH matched AS (
    SELECT
      b.id, b.metro, b.bbl, b.bin, b.apn, b.pin,
      b.folio_number, b.hcad_account,
      b.borough, b.house_number, b.street_name, b.city, b.state,
      b.zip_code, b.full_address, b.name, b.slug,
      b.year_built, b.num_floors, b.total_units,
      b.residential_units, b.commercial_units,
      b.building_class, b.land_use, b.owner_name,
      b.management_company,
      b.overall_score, b.review_count,
      b.violation_count, b.complaint_count, b.litigation_count,
      b.dob_violation_count, b.crime_count,
      b.bedbug_report_count, b.eviction_count, b.permit_count,
      b.energy_star_score, b.is_rent_stabilized,
      b.stabilized_units, b.stabilized_year,
      b.latitude, b.longitude,
      b.is_soft_story, b.soft_story_status, b.is_rso,
      b.fire_risk_zone, b.ward, b.community_area,
      b.is_rlto_protected, b.is_scofflaw,
      b.rlto_violation_count, b.lead_inspection_count,
      b.flood_zone,
      b.forty_year_recert_status, b.forty_year_recert_due_date,
      b.is_condo, b.condo_association,
      b.unsafe_structure_count,
    ...
    FROM buildings b
    WHERE b.full_address >= upper(search_query)
      AND b.full_address < upper(search_query) || '~'
...
-- Keep GIN-based search for name/owner/non-address queries.
-- Simplified: removed unused search_query_alt OR that caused slow BitmapOr.
