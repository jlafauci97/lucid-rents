...
BEGIN
  ...
  WHERE metro = p_metro
    ...
    -- Pattern-based filters catch case + punctuation variants ("Taxpayer Of" vs "TAXPAYER OF",
    -- "City Of Chicago" vs "CITY OF CHICAGO", "CHICAGO TITLE & TRUST" vs "CHICAGO TITLE LAND TRUST", etc.)
    AND UPPER(name) NOT LIKE '%TAXPAYER%'
    AND UPPER(name) NOT LIKE 'CITY OF CHICAGO%'
    AND UPPER(name) NOT LIKE 'COUNTY OF COOK%'
    AND UPPER(name) NOT LIKE 'COOK COUNTY%'
    AND UPPER(name) NOT LIKE 'CHICAGO CITY%'
    AND UPPER(name) NOT LIKE 'CHICAGO HEIGHTS%'
    AND UPPER(name) NOT LIKE 'CHICAGO TITLE%'
    AND UPPER(name) NOT LIKE 'CHICAGO HSING%'
    AND UPPER(name) NOT LIKE 'CHICAGO HOUSING%'
    AND UPPER(name) NOT LIKE 'CHICAGO BOARD OF ED%'
    AND UPPER(name) NOT LIKE 'CHICAGO PARK DIST%'
    AND UPPER(name) NOT LIKE 'CHICAGO TRANSIT%'
    AND UPPER(name) NOT LIKE 'IL DEPT%'
    AND UPPER(name) NOT LIKE 'IL ST TOLL%'
    AND UPPER(name) NOT LIKE 'IL MEDICAL DIST%'
    AND UPPER(name) NOT LIKE 'IL HSE DEVL%'
    AND UPPER(name) NOT LIKE 'METRO WATER%'
    AND UPPER(name) NOT LIKE 'PARKWAY BANK%'
    AND UPPER(name) NOT LIKE 'PARKWAY BK%'
    AND UPPER(name) NOT LIKE 'LASALLE BANK%'
    AND UPPER(name) NOT LIKE 'MARQUETTE BANK%'
    AND UPPER(name) NOT LIKE 'CATHOLIC BISHOP%'
    AND UPPER(name) NOT LIKE 'COM ED%'
    AND UPPER(name) NOT LIKE 'COMM ED%'
    AND UPPER(name) NOT LIKE 'ROBBINS VILLAGE%'
  GROUP BY metro, slug;
