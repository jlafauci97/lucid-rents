    ...
    <aside className="hidden md:flex flex-col w-[240px] shrink-0 bg-[#0F1D2E] rounded-xl p-4 text-white self-start">
      ...
      {buildingName && (
        <div className="pb-3 mb-3 border-b border-white/10">
          <p className="text-xs uppercase tracking-wider text-[#A3ACBE]">
            Reviewing
          </p>
      ...
      {savedLabel && (
        <div className="mt-4 pt-3 border-t border-white/10 text-xs text-[#A3ACBE] flex items-center gap-1.5">
  ...
  const mobile = (
    <div className="md:hidden relative">
      <div className="flex items-center gap-2">
        ...
        >
          <span className="flex items-center justify-center w-5 h-5 rounded-full bg-[#6366F1] text-[10px] font-bold">
            {currentStep + 1}
          </span>
