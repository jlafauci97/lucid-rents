      ...
      <section className="sr-card rs-card">
        ...
        <div className="rs-reco">
          <div className="rs-reco-num">
            <span className="n">{ratingDisplay} / 5</span>
            <span className="rs-reco-bar"><span style={{ width: `${rating > 0 ? Math.round((rating / 5) * 100) : 0}%` }}></span></span>
          </div>
          <div className="rs-reco-meta">
            <b>{rating >= 3.5 ? "Would recommend" : "Mixed feedback"}</b>
            <small>Based on {data.reviews.total} reviews</small>
          </div>
        </div>
          ...
          <section className="sr-card">
            ...
            <div className="walk-top">
              ...
              <div className="walk-summary">
                ...
                <small style={{ display: "block", marginTop: 4, opacity: 0.7, fontSize: 10 }}>Estimated from nearby transit data</small>
              </div>
            </div>
            {closest ? (
              <>
