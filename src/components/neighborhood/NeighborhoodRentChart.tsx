...
function CustomTooltip({
  ...
  return (
    <div className="bg-white border border-[#E2E8F0] rounded-lg shadow-md px-3 py-2.5 text-xs">
      <p className="font-semibold text-[#1A1F36] mb-1.5">
        {formatTooltipMonth(data.month)}
      </p>
      {data.median !== null && (
        <div className="flex items-center gap-2 mb-0.5">
          <span className="w-2.5 h-0.5 bg-[#6366F1] rounded-full inline-block" />
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        <p className="text-[10px] text-[#A3ACBE] mt-3">
