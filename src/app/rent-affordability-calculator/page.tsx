...
export const metadata: Metadata = {
  ...
  description:
    "Find out how much rent you can actually afford. Enter your income and expenses, then discover which NYC neighborhoods fit your budget — backed by real rent data.",
