...
export default function MapPage() {
  ...
  const [layer, setLayer] = useState<LayerToggle>("buildings");
  ...
  return (
    <div className="h-[calc(100vh-64px)] relative">
      ...
      <div className="absolute top-4 left-4 z-[1000] flex flex-col gap-2">
        ...
        {/* Borough filter */}
        <div className="bg-white rounded-lg shadow-lg border border-[#e2e8f0] p-1">
      ...
      {/* Legend */}
      <div className="absolute bottom-6 right-4 z-[1000] bg-white rounded-lg shadow-lg border border-[#e2e8f0] p-3">
        {(layer === "buildings" || layer === "both") && (
          <div className="mb-2">
