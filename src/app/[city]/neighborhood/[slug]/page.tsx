...
// Returns a 0–5 sub-score (A=4.5, B=3.5, C=2.5, D=1.5, F=0.5).
...
export default async function NeighborhoodPage({
  ...
  // Normalize legacy 0–10 avg scores coming from the DB to the 0–5 scale.
  const avgScore = stats.avg_score != null ? normalizeScore(Number(stats.avg_score)) : null;
