  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Link key={s.borough} href={cityPath(`/buildings/${regionSlug(s.borough)}`, city as City)}>
            <Card hover>
              <CardContent className="p-6">
                ...
                <div className="space-y-2 text-sm text-[#5E6687]">
      ...
      <section className="mt-12">
        <h2 className="text-xl font-bold text-[#1A1F36] mb-4">Explore More</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-[#1A1F36] group-hover:text-[#ef4444] transition-colors">Worst Rated Buildings</p>
              <p className="text-xs text-[#5E6687]">Ranked by violations</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-[#1A1F36] group-hover:text-[#8B5CF6] transition-colors">Landlord Directory</p>
              <p className="text-xs text-[#5E6687]">Search by owner name</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-[#1A1F36] group-hover:text-[#d97706] transition-colors">Crime Data</p>
              <p className="text-xs text-[#5E6687]">Safety by zip code</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-[#1A1F36] group-hover:text-[#10b981] transition-colors">Rent Data</p>
              <p className="text-xs text-[#5E6687]">Market prices by area</p>
            </div>
          </Link>
        </div>
      </section>
