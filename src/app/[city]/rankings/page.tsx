...
export default async function RankingsPage({ searchParams }: RankingsPageProps) {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <AdBlock adSlot="RANKINGS_TOP" adFormat="horizontal" />
