...
export default function SyncsPage() {
  ...
  if (!health && !error) {
    return (
      <>
        <MCHeader title="Syncs" subtitle="Cron jobs, data pipelines, RPC health" />
        <main className="flex-1 overflow-y-auto p-8">
          <div className="flex items-center justify-center py-24">
            <div className="text-center">
              <RefreshCw className="w-10 h-10 text-[#3B82F6] animate-spin mx-auto mb-4" />
              <p className="text-[#64748b] text-lg">Loading syncs...</p>
  ...
  return (
    <>
      ...
      <main className="flex-1 overflow-y-auto p-8">
        {/* Status Banner */}
        <div className={`bg-gradient-to-r ${overallBg} text-white rounded-xl mb-6`}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80">Lucid Rents data pipelines</p>
                </div>
              </div>
