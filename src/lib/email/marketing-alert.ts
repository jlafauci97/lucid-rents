  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px;">
    ...
    <div style="background-color: white; padding: 24px; border: 1px solid #e2e8f0; border-top: none;">
      ...
      <div style="text-align: center; margin-top: 24px;">
        <a href="${data.baseUrl}/mission-control/marketing" style="display: inline-block; background-color: #0F1D2E; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 600;">
    ...
    <div style="padding: 16px 24px; text-align: center; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 12px 12px; background-color: #f8fafc;">
      ...
      <p style="margin: 8px 0 0; color: #94a3b8; font-size: 12px;">
        <a href="${data.baseUrl}/mission-control/marketing" style="color: #64748b; text-decoration: none;">
